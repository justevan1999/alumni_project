...
<body>
        ...
        <div class="col-sm-12 col-md-12 col-lg-10">
         ...
         <img class="" src="data:image/png;base64,">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav top-container">
                <div class="nav-top">
    ...
    <div data-aos="fade-down"
     ...
     <section class="text-center mt-5 pull">
      <div class="community">
        <h1 class="build-text">
          Building <span class="my-span">A Community </span> <br />
          For Global Impact
        </h1>
        <p class="build-p">
          Our community of alumni positions our members for global impact and
          greater strides at all levels.
        </p>
      </div>
    </section>
    </div>
